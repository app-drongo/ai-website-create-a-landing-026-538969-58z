...
export default function Cta() {
  ...
  const stats = [
    { value: '200+', label: 'SAP Implementations', icon: Users },
    { value: '99.8%', label: 'System Uptime', icon: Shield },
    { value: '50+', label: 'Module Integrations', icon: Zap },
    { value: '24/7', label: 'ERP Support', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join enterprise clients who have transformed their business processes with our
                expert SAP integration services. Start your digital transformation today.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Comprehensive SAP assessment at no cost
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SAP-certified security protocols and compliance
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go-live in weeks with our proven methodology
              </p>
            </div>
          </div>
        </div>
